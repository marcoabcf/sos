...
<link href="<%=request.getContextPath()%>/assets/css/prettyPhoto.css" rel="stylesheet"> 
...
<link rel="shortcut icon" href="<%=request.getContextPath()%>/assets/images/ico/favicon.png"> 
