...
<div class="container empresa">
    <div class="text-center">
        <div class="row">
            ...
            <p>A empresa ......k askjdhaskjd haskjdhkjas dh ashj dhkjash dkjas hdkjashd kjashdkjas hkdj ask dh kashdkjas hkd shk ahd asj dhkjasdk ajks dkas hdkj ashkjdhas dh askj dhkashdkjas hk dash djashkdjahs kdjaskdhk asdhash dkjas hdkj ashkjdahs dj askj dhaks dahsk dhak sjdaks dkjash asd hasdhjashdkjash dkash dkjashkd ahskd hads ksadhk ash dkashk dkha s.</p>
            <div>
                <div class="col-md-6">
                                    ...
                                    <div class="box-header with-border">
                                        <h4 class="box-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" class="collapsed">
                                                1- Pergunta 1 ashgd hkajsdh sajkdhaskd asijdaskj dhaskjdhask dhkajs dhkjasdkadhkahs dkask d?
                                            </a>
                                        </h4>
                                    </div>
